...
- **Keep gates conservative.** If a metric is not yet measurable with high confidence across the portfolio, keep it informational instead of letting it gate medals.
